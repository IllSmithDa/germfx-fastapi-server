...
from app.services.side_effects import extract_and_save_side_effects_for_detail
...
def extract_side_effects(
    ...
    result = extract_and_save_side_effects_for_detail(
        db,
        detail_id=detail_id,
